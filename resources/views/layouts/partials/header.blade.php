...
<header>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="#"><img src="{{ asset('assets/images/logo.svg') }}" alt=""
                    width="250"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link {{ Route::is('recipe') ? 'active' : '' }} fw-bold" type="button"
                            data-bs-toggle="dropdown" aria-expanded="false" href="#">Recipes</a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item border border-top-0 border-bottom-1 {{ Route::is('recipe') ? 'active' : '' }}" href="{{ route('recipe') }}">All</a></li>
                            {{-- <li><hr></li> --}}
